...
import { LayoutDashboard, Shield, Settings, LogOut, ChevronRight, ArrowUpLeft, Users, Scale } from "lucide-react"
...
export function DashboardSidebar({ guilds, userName, userImage }: Props) {
  ...
  return (
    <aside className="w-60 bg-card border-r border-border/50 flex flex-col shrink-0 min-h-screen">
      {/* Logo */}
      <div className="h-14 flex items-center px-5 border-b border-border/50 shrink-0">
        <Link href={`/${locale}/dashboard`} className="text-lg font-bold tracking-tight">
