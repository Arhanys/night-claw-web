export default {
    ...
    dashboard: {
        ...
        overview: {
            ...
            appealsDesc: "Examiner les demandes d'appel de bannissement",
            ticketsDesc: "Parcourir les transcripts de tickets",
            configuration: "Configuration",
            configDescAdmin: "Voir et modifier les paramètres du bot",
            configDescMod: "Voir les paramètres du bot",
            superAdmin: "Superadmin",
            superAdminRole: "Superadmin",
            superAdminAccess: "Accès à tous les serveurs du bot",
        ...
        tickets: {
            ...
            of: "sur",
            total: "total",
            noTranscript: "Pas de transcript",
            viewTranscript: "Voir le transcript",
            openInTab: "Ouvrir dans un nouvel onglet",
            transcriptTitle: "Transcript du ticket",
            notClosed: "Toujours ouvert",
            unknown: "Inconnu",
        },
        appeals: {
