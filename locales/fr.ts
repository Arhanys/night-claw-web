export default {
    ...
    home : {
        ...
        commandExample: {
            ...
            dashboardPreview: {
                ...
                title: "Votre hub de modération",
                subtitle: "Graphiques, historique des sanctions, appels de bannissement et gestion d'équipe — tout en un.",
                previewBadge: "Aperçu",
                tab: {
                ...
                modTeamLabel: "Équipe de modération",
                sanctionsColAction: "Action",
                sanctionsColTarget: "Cible",
                sanctionsColMod: "Modérateur",
                sanctionsColReason: "Raison",
                sanctionsColDate: "Date",
                appealsColStatus: "Statut",
                appealsColUser: "Appelant",
                appealsColReason: "Raison",
                appealsColDate: "Date",
            },
    },
    guide: {
    ...
    dashboard: {
        ...
        members: {
            ...
            subtitle: "Parcourez tous les membres du serveur ou recherchez par nom / ID Discord.",
            searchPlaceholder: "Rechercher par nom ou ID Discord…",
            search: "Rechercher",
            noSanctions: "Aucune sanction dans ce serveur.",
            noSanctionedMembers: "Aucun membre trouvé.",
            noSearchResults: "Aucun membre ne correspond à votre recherche.",
            recentlySanctioned: "Récemment sanctionnés",
            sanctionedMembers: "Membres sanctionnés",
            sanction: "sanction",
            sanctions: "sanctions",
            ...
            action: "action",
            actions: "actions",
            sortSanctionsDesc: "Plus de sanctions",
            sortSanctionsAsc: "Moins de sanctions",
            sortRecent: "Plus récent",
            nextBatch: "1 000 membres suivants",
            prevBatch: "1 000 membres précédents",
            previous: "Précédent",
            next: "Suivant",
            page: "Page",
            of: "sur",
        ...
        config: {
            ...
            devModeTitle: "Activer le mode développeur Discord",
            devModeDesc: "Allez dans Paramètres utilisateur → Avancé → Mode développeur et activez-le. Vous pouvez ensuite faire un clic droit sur n'importe quel salon, rôle ou serveur pour copier son ID.",
            fields: {
                log_channel_id:        { label: "ID du salon de logs",            description: "Salon où les actions de modération sont enregistrées",              hint: "Clic droit sur le salon souhaité dans votre serveur → Copier l'identifiant du salon" },
                mod_role_id:           { label: "ID du rôle modérateur",          description: "Rôle donnant accès aux commandes de modération",                    hint: "Allez dans Paramètres du serveur → Rôles, clic droit sur le rôle modérateur → Copier l'identifiant du rôle" },
                confession_channel_id: { label: "ID du salon de confessions",     description: "Salon où les confessions anonymes sont publiées",                   hint: "Clic droit sur le salon des confessions → Copier l'identifiant du salon" },
                language:              { label: "Langue",                         description: "Langue des réponses du bot",                                        hint: "Entrez en pour l'anglais ou fr pour le français" },
                source_guild_id:       { label: "ID du serveur principal",        description: "ID du serveur principal — à définir sur le serveur d'appel uniquement", hint: "Clic droit sur le nom du serveur principal → Copier l'identifiant du serveur. À remplir uniquement sur le serveur d'appel, pas sur le serveur principal." },
                appeal_invite_url:     { label: "Invitation du serveur d'appel",  description: "Lien d'invitation envoyé aux utilisateurs bannis en MP",            hint: "Créez une invitation permanente sur votre serveur d'appel (sans expiration, utilisations illimitées) et collez le lien complet ici" },
                main_invite_url:       { label: "Invitation du serveur principal", description: "Invitation permanente envoyée lors de l'acceptation d'un appel",   hint: "Créez une invitation permanente sur votre serveur principal et collez le lien complet ici" },
            },
        },
        tickets: {
